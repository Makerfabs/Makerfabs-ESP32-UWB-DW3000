/*
  Makerfabs DW3000 one-to-one ranging RX example.
...
#define PIN_RST DW3000_PIN_RST
#define PIN_IRQ DW3000_PIN_IRQ
#define PIN_SS DW3000_PIN_CS
...
void setup()
{
  ...
  Serial.println("Makerfabs Range RX");
